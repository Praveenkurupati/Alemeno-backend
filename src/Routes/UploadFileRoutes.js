...
const uploadController = require('../Controllers/UploadData')
...
router.post('/uploadfile',uploadController.uploadCustomers)
router.post('/uploadfile/loan',uploadController.uploadLoans)
// router.post('/uploadfile/loan',uploadController.)
